...
# wishlist connected by many to many table; also has foreign key from users

class Wishlist(models.Model):
    name = models.CharField(max_length=255)
    user = models.ForeignKey(User, related_name="user_key")
    others = models.ManyToManyField(User, related_name="wish_item")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    def __str__(self):
        return "<Wishlist object: {} {} {}>".format(self.name, self.user, self.others)
